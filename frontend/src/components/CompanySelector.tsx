              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  >
                    ...
                    {company.id === "adbe" && (
                      <svg className="h-6 w-6" viewBox="0 0 256 228" fill="currentColor" style={{ color: "#FF0000" }}>
                    ...
                    {company.id === "crm" && (
                      <svg className="h-6 w-6" viewBox="0 0 256 180" fill="currentColor" style={{ color: "#00A1E0" }}>
                    ...
                    {company.id === "now" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#81B5A1" }}>
                        <path d="M5 20V4h3l8 11V4h3v16h-3L8 9v11z" />
                      </svg>
                    )}
                    {company.id === "wday" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#005CB9" }}>
                    ...
                    {company.id === "veev" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#F68D2E" }}>
                        <path d="M2 4h4.5l5.5 14.5L17.5 4H22L12 22z" />
                      </svg>
                    )}
                    {company.id === "ddog" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#632CA6" }}>
                    ...
                    {company.id === "tyl" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#004976" }}>
                        <path d="M3 4h18v4.5h-7V20h-4V8.5H3z" />
                      </svg>
                    )}
                    {company.id === "fico" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#003A70" }}>
                        <path d="M5 4h14v4H10v3h8v4h-8v5H5z" />
                      </svg>
                    )}
                    {company.id === "nxpi" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#00479D" }}>
                    ...
                    {company.id === "amat" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#005CAB" }}>
                        <path d="M12 2L3 22h4.5l1.5-4h6l1.5 4H21L12 2zm0 7l2.5 7h-5L12 9z" />
                      </svg>
                    )}
                    {company.id === "entg" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#1D428A" }}>
                        <path d="M5 4h14v3.5H10v3h8v3.5h-8v3h9V21H5z" />
                      </svg>
                    )}
                    {company.id === "ftnt" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#EE3124" }}>
                    ...
                    {company.id === "panw" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#F04E23" }}>
                    ...
                    {company.id === "meta" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#0467DF" }}>
                    ...
                    {company.id === "msi" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#005A8B" }}>
                    ...
                    {company.id === "br" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#000C36" }}>
                        <path d="M3 6h7l3 3-3 3H3zm0 6h7l3 3-3 3H3z" />
                        <path d="M21 6h-7l-3 3 3 3h7zm0 6h-7l-3 3 3 3h7z" />
                      </svg>
                    )}
                    {company.id === "tru" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#00A6CA" }}>
                        <path d="M3 4h18v4.5h-7V20h-4V8.5H3z" />
                      </svg>
                    )}
                    {company.id === "csgp" && (
                      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#003DA5" }}>
